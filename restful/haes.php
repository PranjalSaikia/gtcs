<?php
	...
	$q = "SELECT * FROM haes WHERE name=:name AND phn=:phn AND email=:email AND reqs=:reqs";
	...
	$stmt->execute();
	if($stmt->rowCount()==0){
		$q1 = "INSERT INTO haes(name,email,phn,reqs,address,location,is_del) VALUES(:name,:email,:phn,:reqs,:address,:location,'0')";
